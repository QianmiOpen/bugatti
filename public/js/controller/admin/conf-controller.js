...
define(['angular'], function(angular) {
    ...
    var app = angular.module('bugattiApp.controller.admin.confModule', ['angularFileUpload']);
        ...
        function($scope, $state, $stateParams, $modal, ConfService) {
            ...
            $scope.delete = function(cid) {
                ...
                modalInstance.result.then(function(data) {
                    $state.go('admin.project.version.conf.list', {eid: $scope.env.id})
                });
            };
    ...
    app.controller('ConfEditCtrl', ['$scope', '$state', '$filter', '$stateParams', '$modal',
        ...
        function($scope, $state, $filter, $stateParams, $modal, ConfService) {
            ...
            $scope.cancel = function() {
                $state.go('admin.project.version.conf.detail', {cid: $stateParams.cid})
            };
