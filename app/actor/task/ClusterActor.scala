...
case class SuccessReplaceCommand(commandList: Seq[TaskCommand], tq: TaskQueue, templateStep: Seq[TemplateActionStep], hosts: Seq[EnvironmentProjectRel], hostsIndex: Int, taskObj: ProjectTask_v, taskDoif: Seq[String])
