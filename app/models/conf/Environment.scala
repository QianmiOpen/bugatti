 ...
 * @author of546
 */
case class Environment(id: Option[Int], name: String, jobNo: Option[String], remark: Option[String], nfServer: Option[String], ipRange: Option[String], level: Level, scriptVersion: String = ScriptVersionHelper.Latest)
